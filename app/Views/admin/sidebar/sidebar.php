...
<body>
    <div class="sidebar d-flex flex-column">
        ...
        <!-- Portfolio Submenu -->
        <a href="#" class="has-submenu" id="toggle-portfolio">
            <i class="bi bi-briefcase me-2"></i> Portfolio Settings
            <i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <div id="portfolio-submenu" class="submenu">
            <a href="/admin/portfolio"><i class="bi bi-circle me-2"></i> Portfolio (Index)</a>
            <a href="/admin/kegiatan"><i class="bi bi-circle-fill me-2"></i> All Portfolio</a>
        </div>
