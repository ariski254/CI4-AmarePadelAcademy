  ...
  <div class="content">
      ...
      <div class="footer-container">
          ...
          <form action="<?= site_url('admin/footer/update'); ?>" method="post" enctype="multipart/form-data"
              ...
              <div class="footer-logo-preview mt-3">
                  <img src="<?= base_url($footer['logo_path']); ?>" alt="Logo Footer" width="100"
              ...
              <button type="submit" class="footer-submit-btn mt-4">Update Footer</button>
          </form>
      </div>
